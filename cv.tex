...
\makecvfooter{Last Update: \today}{Shan Jiang~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\cventry
{Leader} % Role
{Research on Application of Block Chain Technology in Supply Chain Tracking} % Project Name
{HK PolyU \& Alibaba} % Location
...
\cventry
{Member} % Role
{High-precision Indoor Localization for Large-scale Warehouse} % Project Name
{HK PolyU \& Alibaba} % Location
{Feb. 2018 - Present} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
